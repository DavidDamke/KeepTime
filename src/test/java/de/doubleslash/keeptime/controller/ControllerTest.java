...
public class ControllerTest {
   ...
   public void shouldCalculateSecondsCorrectlyWhenWorkItemsAreGiven() {
      ...
      workItems.add(
            new Work(localDateTimeMorning.plusHours(2), localDateTimeMorning.plusHours(3), nonworkProject1, ""));
      workItems.add(
            new Work(localDateTimeMorning.plusHours(3), localDateTimeMorning.plusHours(4), nonworkProject2, ""));
